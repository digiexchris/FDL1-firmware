...
void ClickButton::setup(uint8_t buttonPin)
{
  _pin           = buttonPin;
...
void ClickButton::setup(uint8_t buttonPin, bool activeType)
{
  _pin           = buttonPin;
...
void ClickButton::setup(uint8_t buttonPin, bool activeType, bool internalPullup)
{
  _pin           = buttonPin;
  _activeHigh    = activeType;
  _btnState      = !_activeHigh;  // initial button state in active-high logic
